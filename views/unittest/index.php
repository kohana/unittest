...
<div id="select">
	...
	<div id="groups">
		...
		<fieldset class="reports">
			...
			<?php if ( ! $xdebug_enabled): ?>
				<p>Xdebug needs to be installed to generate reports</p>
			<?php else: ?>
				<?php echo Form::open($report_uri, array('method' => 'GET')) ?>

				<?php echo Form::label('cc_group', 'Generate report for') ?>
				<?php echo Form::select('group', $groups, NULL, array('id' => 'cc_group'));?>

				<?php echo Form::label('report_archive', 'Download as archive?');?>
				<?php echo Form::checkbox('archive', 1, FALSE, array('id' => 'report_archive')) ?>

				<?php echo Form::label('report_use_whitelist', 'Use code coverage whitelist');?>
